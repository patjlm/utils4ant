 ...
 * @since Ant 1.7
 */
public class MyOr extends ResourceSelectorContainer implements ResourceSelector {
     ...
     */
    public MyOr(ResourceSelector[] r) {
        super(r);
    }
    ...
    public boolean isSelected(Resource r) {
    	...
    	getProject().log("Or Matching [" + r.getName() + "] = " + ret, Project.MSG_DEBUG);
        return ret;
    }
